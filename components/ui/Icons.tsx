...
export const UgandanFlagIcon: React.FC<{className?: string}> = ({className}) => (
 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 6 4" className={className}>
    <path fill="#D90000" d="M0 2h6v2H0z"/>
    <path fill="#FCDC04" d="M0 1h6v1H0z"/>
    <path d="M0 0h6v1H0z"/>
    <g transform="translate(3 2)">
      <circle r="0.6" fill="#fff"/>
      <g fill="#000" transform="scale(0.025)">
        <path d="M-10-12a10 8 0 0 1 20 0v16h-2v-4h-4v4h-2v-4h-4v4h-2v-4H-8v4h-2z"/>
        <path d="m-12 5 2 2v6h2v-5l2 2 2-2-2-2-2 2z"/>
      </g>
    </g>
  </svg>
);
...
export const TamperIcon: React.FC<{className?: string}> = ({className}) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const KeyIcon: React.FC<{className?: string}> = ({className}) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 5.25a3 3 0 0 1 3 3m3 0a6 6 0 0 1-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H3.75v-1.5a1.5 1.5 0 0 1 1.5-1.5h1.5v-1.5H8.25v-1.5h2.25v-1.5l3.159-3.159c.404-.404.527-1 .43-1.563A6 6 0 1 1 21.75 8.25z" />
    </svg>
);
...
export const RolesIcon: React.FC<{className?: string}> = ({className}) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.944a11.955 11.955 0 019-2.606 11.955 11.955 0 019 2.606c.329-3.515-.758-7.243-3.382-10.032z" />
    </svg>
);
